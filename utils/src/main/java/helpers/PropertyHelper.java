...
{
    public static  <C extends Enum<C> & StringMethods> void init(Class<C> enumClass, String path)
    {
        try {
    ...
    private static  <C extends Enum<C> & StringMethods> void setSystemProperties(Class<C> enumClass, Properties prop)
    {
